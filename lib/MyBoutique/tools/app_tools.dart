...
import 'package:kibabi_market/MyBoutique/tools/progressdialog.dart';
...
Widget loadImage(BuildContext context, File image) {
  return Container(
    ...
    decoration: new BoxDecoration(
        color: Colors.grey.withAlpha(100),
        image: new DecorationImage(
            fit: BoxFit.cover, image: new FileImage(image))),
  );
}

Widget loadMinim(BuildContext context, String image) {
  return Container(
    width: 75.0,
    height: 75.0,
    decoration: new BoxDecoration(
