...
class EcommerceOnePage extends StatelessWidget {
  final List<String> categories = ['DarazMall', 'Flash Sales', 'Collection', 'Vouchers', 'Categories','Accessoir'];
  final List<String> images = ['assets/img/1.jpg','assets/img/3.jpg','assets/img/2.jpg', 'assets/img/4.jpg','assets/img/5.jpg'];
  final List<String> flashSaleImages = ['assets/img/b1.jpg','assets/img/b3.jpg','assets/img/b2.jpg','assets/img/b3.jpg','assets/img/5.jpg'];
  final List<IconData > mesIcon=[Icons.card_travel,Icons.card_giftcard,Icons.cake,Icons.business,Icons.error,Icons.eject];
            ...
            child: Column(
              children: <Widget>[
                CircleAvatar(
                  ...
                  maxRadius: 30.0,
                  child: Icon(mesIcon[index%mesIcon.length],color: Colors.white,),
                ),
                SizedBox(height: 8.0,),
